...
class Famous_Quotes_Collection_Quote {
	public $quote_id;
	public $quote;
	public $author;
	public $tags;
	...
	public static function with_quote( $quote ) {
		$instance = new Famous_Quotes_Collection_Quote( array( 'quote' => $quote ) );
		return $instance;
	}
	...
	public function output_format( $options = array() ) {
		...
		if( $options['show_author'] && $this->author ) {
			$attribution = '<a href = "famous-quotes-collection.php" target="_blank"> <cite class="author">' . $this->author . '</cite></a>';
		}
