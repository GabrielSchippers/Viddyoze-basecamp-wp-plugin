...
class Famous_Quotes_Collection_Admin_List_Table extends WP_List_Table {
	...
	function prepare_items() {
		...
		$per_page = $this->get_items_per_page( 'quotescollection_items_per_page', 15 );
